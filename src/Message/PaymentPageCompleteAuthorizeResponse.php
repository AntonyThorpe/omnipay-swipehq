...
class PaymentPageCompleteAuthorizeResponse extends AbstractResponse
{
     ...
     *
     * @return string A reference provided by the gateway to represent this completed transaction.
     * Note this is not the identifier_id generated using the createTransactionIdentifier API
     */
     ...
     *
     * @return string Another message provided by the gateway to represent to represent
